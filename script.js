...
document.addEventListener('DOMContentLoaded', function() {
    ...
    displayButton.addEventListener('click', function() {
        ...
        restaurants.forEach(function(restaurant) { 
            restaurantList.innerHTML += "<div>"
            restaurantList.innerHTML += restaurant.name + "<br>";
            restaurantList.innerHTML += restaurant.cuisine + "</div><br>"
        })
    ...
    filterButton.addEventListener('click', function() {
        ...
        cheapRestaurants.forEach(function(restaurant) {
            filteredList.innerHTML += "<div>"
            filteredList.innerHTML += restaurant.name + "<br>";
            filteredList.innerHTML += restaurant.priceRange + "</div><br>"
        })
    ...
    findButton.addEventListener('click', function() {
        ...
        foundItem.innerHTML = "<h3>" + bestRestaurant.name + "</h3><br>";
        foundItem.innerHTML += bestRestaurant.cuisine + "<br>";
        foundItem.innerHTML += bestRestaurant.rating;
